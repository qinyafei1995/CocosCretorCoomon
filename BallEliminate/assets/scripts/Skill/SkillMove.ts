...
@ccclass
export default class SkillMove extends SkillBase {
     ...
     */
    public init(initAngle: number = this.initRotation, r: number = this.r, rotateSpeed: number = this.rotationSpeed, shoot: number = this.shootSpeed) {
        super.init();
